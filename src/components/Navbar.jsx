            ...
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <nav className="hidden md:flex items-center gap-1">
                        <Link
                            to="/"
                            className={`px-3 py-2 rounded-lg font-medium text-sm transition-all duration-300 ${darkMode ? 'text-gray-300 hover:text-white hover:bg-white/10' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'}`}
                        >
                            Home
                        </Link>
                        <Link
                        ...
                        <button
                            onClick={toggleTheme}
                            className={`p-2 rounded-lg transition-all duration-300 ${darkMode ? 'text-yellow-300 hover:bg-white/10' : 'text-gray-600 hover:bg-gray-100'}`}
                ...
                <div className={`md:hidden border-t ${darkMode ? 'bg-slate-900/95 border-purple-900/30' : 'bg-white/95 border-gray-200'} backdrop-blur-xl`}>
                    <div className="px-4 pt-2 pb-6 space-y-2">
                        <Link
                            ...
                            className={`block px-3 py-3 rounded-lg font-medium text-base ${darkMode ? 'text-gray-300 hover:text-white hover:bg-white/10' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'}`}
                        >
                            Home
                        </Link>
                        <Link
